    ...
    public partial class frmKitchenView : Form
    {
        ...
        private void GetOrders()
        {
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                lb2.Text = "Cashier Name : " + dt1.Rows[i]["CashierName"].ToString();
                lb3.Text = "OrderType : " + dt1.Rows[i]["ordertype"].ToString();
        ...
        private void b_Click(object sender, EventArgs e)
        {
            ...
            if (guna2MessageDialog1.Show("Complete Order?") == DialogResult.Yes)
            {
